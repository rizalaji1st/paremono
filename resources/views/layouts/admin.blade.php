				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						...
						<a href="../../demo1/dist/index.html">
							<img alt="Logo" src="{{ asset('metronic/assets/media/logos/sipecuran-light.png')}}" class="h-30px logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								@can('administrator')
									...
									@can('are-superAdmin')
										...
										<div class="menu-item">
											<a class="menu-link @yield('menu_admin_manajemen_wilayah_active')" href="{{url('/admin/manajemen-wilayah')}}">
												<span class="menu-icon">
													<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
													<span class="svg-icon svg-icon-2">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									@endcan
									<div class="menu-item">
										<a class="menu-link @yield('menu_admin_manajemen_curah_hujan_active')" href="{{url('/admin/manajemen-curah-hujan')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<span class="menu-title">Manajemen Curah Hujan</span>
										</a>
									</div>
								@endcan
								<div class="menu-item">
									<a class="menu-link @yield('menu_publik_data_curah_hujan_active')" href="{{url('/publik/data-curah-hujan')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<span class="menu-title">Data Curah Hujan</span>
									</a>
								</div>
							</div>
							<!--end::Menu-->
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="../../demo1/dist/index.html" class="d-lg-none">
									<img alt="Logo" src="{{ asset('metronic/assets/media/logos/sipecuran-logo.png')}}" class="h-40px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Wrapper-->
